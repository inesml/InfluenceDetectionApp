...
// VISUALIZACION PARA EL ALGORTIMO DE PAGERANK
...
function pintarGrafo(tipoGrafo, nodos) {
                ...
                case 'Usuario':
                    return "<strong>Usuario</strong>" +
                        ...
                        "<strong>Nº Amigos: " + d['num_friends'] + "</strong>"
                         + "<br>"+
                        "<strong>Valor PageRank: "+ d['pagerank'] +"</strong>";
                case 'Mencionado':
    ...
    var node = svg.selectAll(".node")
        ...
        .attr("r", function (d) {
                    return 5+(2*d['pagerank']);
                    // return 5+(10* d['pagerank']);
        })
        .call(force.drag)
...
function refrescarGrafico(valor) {
    ...
    pintarGrafo('pagerank', nodosFiltrados);
