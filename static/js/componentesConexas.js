...
// VISUALIZACION PARA EL ALGORTIMO DE DETECCION DE COMUNIDADES COMPONENTES CONEXAS
...
function pintarGrafo(tipoGrafo, nodos) {
            ...
            switch (d['type']) {
                case 'Usuario':
                    return "<strong>Usuario</strong>" +
                        ...
                        + "<br>"+
                        "<strong>Componente conexa "+ d['partition'] +"</stong>";
                case 'Mencionado':
    ...
    var node = svg.selectAll(".node")
        ...
        // console.log(comunidadesComponentesConexas);
        .attr("fill", function(d){
            return color(d.partition);
        })
...
function refrescarGrafico(valor) {
    ...
    pintarGrafo('componentesConexas', nodosFiltrados);
