...
// VISUALIZACION PARA EL ALGORTIMO DE CLOSENNESS
...
function pintarGrafo(tipoGrafo, nodos) {
                ...
                case 'Usuario':
                    return "<strong>Usuario</strong>" +
                        ...
                        "<strong>Nº Amigos: " + d['num_friends'] + "</strong>"
                         + "<br>"+
                        "<strong>Valor Closenness: "+ d['centrality'] +"</strong>";
                case 'Mencionado':
    ...
    var node = svg.selectAll(".node")
        ...
        .attr("class", "node")
        // Tamaño del nodo en funcion del valor del Closenness
        .attr("r", function (d) {
                    return 8+(500* d['centrality']);
                    // return 8+(50* d['centrality']);
        })
        .call(force.drag)
...
function refrescarGrafico(valor) {
    ...
    pintarGrafo('closenness', nodosFiltrados);
